    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="apimain">센터 목록</a>
          <a class="collapse-item" href="program">구민체육센터 프로그램</a>
        </div>
      </div>
    </li>
        ...
        <div class="row">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">체육 센터</h6>
            </div>
            <div class="card-body">
              <%
                for (ProgramApiResponse program : programList) {
              %>
              <p><b><%=program.getProgramName()%></b></p>
              <p><%=program.getTime()%></p>
              <p><%=program.getProgramDate()%></p>
              <p><%=program.getTarget()%></p>
              <p><%=program.getProgramMaxPeople()%></p>
              <p><%=program.getPrice()%></p>
              <%
                }
              %>
            </div>
