          ...
          <div class="p-5">
            ...
            <form class="user" method="post" action="/user/insertUserInfo">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="password" class="form-control form-control-user"
                         id="exampleRepeatPassword" name="password" placeholder="비밀번호 확인">
                </div>
              </div>
              <div> <input type="submit" class="btn btn-primary btn-user btn-block" value="회원가입"> </div>
            </form>
            <hr>
            <div class="text-center">
              <a class="small" href="/user/password">비밀번호를 잊으셨습니까?</a>
            </div>
            <div class="text-center">
