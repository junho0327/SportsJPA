                                ...
                                <form class="user" name="f" method="post" action="/user/getUserLoginCheck" onsubmit="return doLoginUserCheck(this);">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                               id="exampleInputEmail" name="userId" placeholder="아이디">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" onclick="doLoginUserCheck(f)" value="로그인" class="btn btn-primary btn-user btn-block">
                                    </input>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/user/password">비밀번호 변경</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="/user/UserRegForm">회원가입</a>
                                    </div>
                                </form>
                            </div>
                        </div>
